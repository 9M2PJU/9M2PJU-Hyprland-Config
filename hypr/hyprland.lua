...
hl.workspace_rule({ workspace = "2", monitor = "HDMI-A-2", default = true, persistent = true })
...
hl.bind(mainMod .. " + SHIFT + V", hl.dsp.exec_cmd("bash ~/.config/hypr/scripts/clipboard.sh"))
hl.bind(mainMod .. " + H", hl.dsp.exec_cmd("bash ~/.config/hypr/scripts/clipboard.sh"))
...
hl.bind(mainMod .. " + W", hl.dsp.exec_cmd("bash ~/.config/hypr/scripts/window-list.sh"))
