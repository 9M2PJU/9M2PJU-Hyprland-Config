...
hl.bind("ALT + TAB", hl.dsp.exec_cmd("hyprswitch gui --mod-key ALT --key TAB --close mod-key-release"))
hl.bind("ALT + SHIFT + TAB", hl.dsp.exec_cmd("hyprswitch gui --mod-key ALT --key TAB --close mod-key-release -r"))
hl.bind(mainMod .. " + TAB", hl.dsp.exec_cmd("hyprswitch gui --mod-key SUPER --key TAB --close mod-key-release"))
hl.bind(mainMod .. " + SHIFT + TAB", hl.dsp.exec_cmd("hyprswitch gui --mod-key SUPER --key TAB --close mod-key-release -r"))
