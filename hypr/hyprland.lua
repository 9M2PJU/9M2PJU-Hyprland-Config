...
-- Window Switching (Visual Alt+Tab & Super+Tab GUI via hyprswitch)
hl.bind("ALT + TAB", hl.dsp.exec_cmd("hyprswitch gui --mod-key alt --key tab --close mod-key-release && hyprswitch dispatch"))
hl.bind("ALT + SHIFT + TAB", hl.dsp.exec_cmd("hyprswitch gui --mod-key alt --key tab --close mod-key-release && hyprswitch dispatch -r"))
hl.bind(mainMod .. " + TAB", hl.dsp.exec_cmd("hyprswitch gui --mod-key super --key tab --close mod-key-release && hyprswitch dispatch"))
hl.bind(mainMod .. " + SHIFT + TAB", hl.dsp.exec_cmd("hyprswitch gui --mod-key super --key tab --close mod-key-release && hyprswitch dispatch -r"))
